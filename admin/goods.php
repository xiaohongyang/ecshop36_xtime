...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    if (($_FILES['goods_img']['tmp_name'] != '' && $_FILES['goods_img']['tmp_name'] != 'none') or (($_POST['goods_img_url'] != $_LANG['lab_picture_url'] && $_POST['goods_img_url'] != 'http://') && $is_url_goods_img = 1))
    {
        ...
        elseif ($_POST['goods_img_url'])
        {
            ...
            if(preg_match('/(.jpg|.png|.gif|.jpeg)$/',$_POST['goods_img_url'], $match) && copy(trim($_POST['goods_img_url']), ROOT_PATH . 'temp/' .md5($_POST['goods_img_url']).$match[1]))
            {
                  $original_img = 'temp/' . md5($_POST['goods_img_url']).$match[1];
            }
        }
