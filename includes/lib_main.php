    ...
    if ($filename != 'index')
    {
        ...
        if (in_array($filename, array('category', 'goods', 'article_cat', 'article', 'brand')))
        {
            ...
            if (!empty($cat_arr))
            {
                ...
                {
                    $page_title = htmlspecialchars($val['cat_name']) ;
        ...
        else
        {
            ...
            {
                $page_title = $GLOBALS['_LANG']['group_buy_goods'];
                $args       = array('gbid' => '0');
            ...
            {
                $page_title = $GLOBALS['_LANG']['auction'] ;
                $args       = array('auid' => '0');
            ...
            {
                $page_title = $GLOBALS['_LANG']['snatch'] ;
                $args       = array('id' => '0');
            ...
            {
                $page_title = $GLOBALS['_LANG']['wholesale'] ;
                $args       = array('wsid' => '0');
            ...
            {
                $page_title = $GLOBALS['_LANG']['exchange'];
                $args       = array('wsid' => '0');
