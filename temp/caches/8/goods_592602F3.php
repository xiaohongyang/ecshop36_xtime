<?php exit;?>a:3:{s:8:"template";a:5:{i:0;s:51:"D:/clientweb/Xtime/wwwroot/themes/default/goods.dwt";i:1;s:65:"D:/clientweb/Xtime/wwwroot/themes/default/library/page_header.lbi";i:2;s:67:"D:/clientweb/Xtime/wwwroot/themes/default/library/goods_gallery.lbi";i:3;s:62:"D:/clientweb/Xtime/wwwroot/themes/default/library/add_cart.lbi";i:4;s:65:"D:/clientweb/Xtime/wwwroot/themes/default/library/page_footer.lbi";}s:7:"expires";i:1503646670;s:8:"maketime";i:1503643070;}<!doctype html>
<html>
<head>
  <meta charset="utf-8" />
...
<body><div class="x-around">
    <div class="x-head" style="background:#FEFFFF">
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="x-headax x-headaxhui addCollect" data-goods="2">
            </div>
            <div class="goods-gallery">
                  <div class="slider">
       <div class="slider-box">
           <ul>
                          <li><a href="images/201704/thumb_img/2_thumb_P_1493176858668.jpg"><img src="images/201704/thumb_img/2_thumb_P_1493176858668.jpg" width="100%" alt=""></a></li>
                              <li><a href="images/201705/thumb_img/2_thumb_P_1495451671230.jpg"><img src="images/201705/thumb_img/2_thumb_P_1495451671230.jpg" width="100%" alt=""></a></li>
                          </ul>
       </div>
   </div>
   <script>
       $(document).ready(function() {
           ...
           $(".slider a").click(function (e) { 
            ...
            <div class="x-shopname">
                <span>手机2                    <span class="x-shopcolor"></span>
                </span>
            </div>
            ...
            <div class="x-shopprice">
                <span class="x-shopuser">会员价：<em class="x-xinghuibi">673</em>.00星辉币</span>
                <span class="x-shopoprice">原价：807.60</span>
            </div>
            <div class="x-shopzk">
                            </div>
        </div>
        <div class="x-main">
                        <div class="x-gouxuan">
                <div class="x-gxshop addCart" data-id="2" data-for=".selected-attr">
                    <div class="x-left " >
        ...
        <div class="x-footer row x-row">
            ...
            <div class="col-xs-5 x-addshop">
                <a href="javascript:;" class="addCart" data-id="2" data-for=".selected-attr">加入购物车</a>
            </div>
            <div class="col-xs-5 x-addbuy">
                <a href="javascript:;" class="addCart" data-id="2" data-buy="true" data-for=".selected-attr">立即购买</a>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.getJSON('user.php?act=has_collect&id=2', function (data) {
            if (data.code == 0) {
