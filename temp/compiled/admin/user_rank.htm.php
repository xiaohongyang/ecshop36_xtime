...
?>
  <tr>
    ...
    <td align="right"><span <?php if ($this->_var['rank']['special_rank'] == 1): ?> onclick="listTable.edit(this, 'edit_year', <?php echo $this->_var['rank']['rank_id']; ?>)" <?php endif; ?> ><?php echo $this->_var['rank']['year_points']; ?></span></td>
