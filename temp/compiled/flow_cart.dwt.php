...
<div class="box">
    <div class="content" style="margin-bottom:180px;background-color:#eee;border:1px solid #E5E5E5;min-height:520px;border-bottom:none">
...
?>
            <div class="carbot goods-item" data-rec="<?php echo $this->_var['goods']['rec_id']; ?>">
                <div class="carin"><span></span></div>
                <dl>
                    <dt><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" /></a></dt>
                    <dd><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>"><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></a></dd>
                    <dd class="hui goods-attr">
                        <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>">
                            <?php echo nl2br($this->_var['goods']['goods_attr']); ?></a></dd>
                    <dd class="san goods-price"><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>">
                        <span class="price"><?php echo $this->_var['goods']['goods_price']; ?></span></a>
                        <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" class="right number-label">X<?php echo $this->_var['goods']['goods_number']; ?></a></dd>
                    <dd class="san number-group">
                        ...
                        <input type="text" value="<?php echo $this->_var['goods']['goods_number']; ?>"  class="txt number" style="width:60px;height:30px;line-height:30px;border:1px solid #ccc;background-color:#fff;text-align:center;float:left" />
