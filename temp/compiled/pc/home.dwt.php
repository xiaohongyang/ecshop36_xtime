...
?>
            <div>
                <dl>
                    ...
                    <dd>
                        <p class="one"><a href="<?php echo $this->_var['goods']['url']; ?>"><?php echo $this->_var['goods']['goods_name']; ?></a></p>
                        <p class="two"><a href="<?php echo $this->_var['goods']['url']; ?>"><?php echo $this->_var['goods']['goods_brief']; ?></a></p>
                        <p class="three"><a href="<?php echo $this->_var['goods']['url']; ?>">原价:<span><?php echo price_format($this->_var['goods']['market_price'], false); ?></span></a></p>
                        <p class="four"><a href="<?php echo $this->_var['goods']['url']; ?>">现价:<span><?php echo price_format($this->_var['goods']['shop_price'], false); ?></span></a></p>
                        <p class="five"><a href="<?php echo $this->_var['goods']['url']; ?>"><img src="themes/default/img/16.png" />加入购物车</a></p>
                    </dd>
