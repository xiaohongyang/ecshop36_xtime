...
?>
                        <div class="caddress-list-details" data-id="<?php echo $this->_var['address']['address_id']; ?>">
                            ...
                            <div class="corder-left corder-padr">
                                ...
                                <p>
                                    <span>详细地址：<?php echo $this->_var['address']['address']; ?></span>
                                    <span>邮编：<?php echo $this->_var['address']['zipcode']; ?></span>
                                </p>
                            </div>
                            <div class="corder-right">
                                <?php if ($this->_var['address']['address_id'] == $this->_var['user_info']['address_id']): ?>
...
<script>
    $(document).ready(function () {
        ...
        $.extend($.validator.messages, {
            ...
            equalTo: "你的输入不相同",
            extension: "请输入有效的后缀",
            maxlength: $.validator.format("最多可以输入 {} 个字符"),
            minlength: $.validator.format("最少要输入 {} 个字符"),
            rangelength: $.validator.format("请输入长度在 {} 到 {1} 之间的字符串"),
            range: $.validator.format("请输入范围在 {} 到 {1} 之间的数值"),
            max: $.validator.format("请输入不大于 {} 的数值"),
            min: $.validator.format("请输入不小于 {} 的数值")
        });
