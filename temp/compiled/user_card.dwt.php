<?php echo $this->fetch('library/page_header.lbi'); ?>
 ...
 <div class="box">
    <div class="content">
      ...
      <div class="wdzh">
        <dl>
          <dt><img src="<?php echo $this->_var['info']['avatar']; ?>" /></dt>
          <dd class="lvbei"><?php echo $this->_var['info']['rank_name']; ?></dd>
          <dd><a href="javascript:;"><?php echo $this->_var['info']['nick_name']; ?></a></dd>
          <dd><a href="javascript:;">会员ID:<?php echo $this->_var['info']['user_id']; ?></a></dd>
        </dl>
      </div>
      <ul class="memberindexull" style="margin-bottom:0;background-color:#E5E5E5;border-bottom:none">
        <li>
          <a href="javascript:;">兑换星辉会员等级:</a><br />
          <a href="javascript:;" style="color:#949494;display:block;">当前:<?php echo $this->_var['info']['rank_name']; ?></a>
        </li>
        <li></li>
      </ul>
      <ul class="memberindexul member-indexul">
